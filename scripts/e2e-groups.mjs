 ...
 * группы взвешены по замеру времени на стенде (3 сентября): smoke 26 %,
 * panel-states 17 %, admin-layout 15 %, admin-shell 12 %, company-legal 9 %,
 * review-moderation 7 %, lead 6 %, остальные 8 %. Каждая группа — свой раннер
 * со своей базой и одним воркером, поэтому порядок и общая база внутри группы
 * остаются как были.
 *
...
export const GROUPS = Object.freeze({
  /** Публичный сайт: дымовые сценарии лендинга и разделов. */
  site: ['smoke'],
  /** Оболочка панели: раскладка по ширинам, навигация, клавиатура. */
  shell: ['admin-layout', 'admin-shell'],
  /** Панель: состояния блоков данных и настройки компании. */
  panel: ['panel-states', 'company-legal'],
