...
/**
 * 🔴 Тревога вместо направления (issue #590): у очереди обращений важна не
 * динамика, а то, что самое старое висит вторые сутки. Стрелки нет — «↓ 1
 * сутки» читалось бы наоборот тому, что означает.
 */
export const Alert: Story = {
  ...
  args: {
    ...
    value: '3',
    delta: { trend: 'alert', value: '1 сутки' },
    note: 'ждут ответа',
  },
};
