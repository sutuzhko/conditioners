...
export type ClientCard = {
  ...
  /**
   * Наряды человека — три колонки списка (issue #602, макет `Clients.png`):
   * сколько их было, на какую сумму и когда был последний.
   *
   * 🔴 Отменённые не в счёт: за них никто не ездил, и складывать их в «на
   * сумму» значит обещать выручку, которой не было.
   */
  readonly orderCount: number;
  readonly orderSum: number;
  /** ISO последнего наряда; `null` — работ ещё не было. */
