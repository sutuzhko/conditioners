 ...
 *
 * 🔴 `robots` здесь не объявляется намеренно. Next ставит ответу этой границы
 * свой `<meta name="robots" content="noindex">`, и собственная директива
 * рядом давала **два разных тега robots на одной странице** — «noindex» и
 * «noindex, follow». Роботу это не запрет и не разрешение, а повод гадать.
 * Одного тега достаточно: `noindex` без `nofollow` и означает «не
 * индексировать, по ссылкам ходить» — то самое поведение, которое нужно.
 */
