...
describe('Страница 404', () => {
  ...
  /* 🔴 Своей директивы у страницы нет намеренно: `noindex` этой границе
     ставит сам Next, и вторая директива рядом давала два разных тега robots
     на одной странице. Тег остаётся один — это проверяет сквозной сценарий,
     здесь же закрепляется, что мы его не добавляем обратно. */
  it('🔴 не объявляет своего robots — тег на странице ровно один', () => {
