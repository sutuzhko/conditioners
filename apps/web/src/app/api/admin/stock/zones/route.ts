 ...
 *
 * Список открыт владельцу и монтажнику (перечень `FIELD`), но монтажнику
 * репозиторий отдаёт только его машины: остаток гаража — это ещё и закупочные
 * привычки владельца, и открывать их всей команде он не обязан (ADR-134).
 * Заводит зоны владелец.
 */
