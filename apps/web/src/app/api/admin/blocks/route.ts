 ...
 *
 * Список открыт владельцу и монтажнику (перечень `FIELD`): монтажник заводит
 * и снимает свою занятость сам — это его врач и его дела. Чью занятость он
 * увидит, решает репозиторий, там же, где стоит отбор по человеку.
 *
