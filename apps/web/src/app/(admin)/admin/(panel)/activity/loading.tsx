 ...
 * списком людей. Полосы-заготовки под него нет намеренно: её высоту пришлось
 * бы назначить числом, а ряд из шести условий переносится по-разному на
 * каждой ширине. Здесь высота совпадает по построению — полей столько же, и
 * переносятся они одинаково; отличается только содержимое списка «Кто», а оно
 * ширину поля не двигает. Тем же приёмом сделана заготовка блока отбора на
 * самой странице.
 *
