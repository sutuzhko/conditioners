...
/* Своего `metadata.title` у сводки нет намеренно. Шаблон `%s · Панель
   управления` живёт в раскладке `(panel)`, а собственная страница раскладки
   берёт из неё `default`, а не `template`: заголовок вкладки вышел бы голым
   «Сводка», без имени панели. Заголовок экрана даёт `h1` — он и был нужен. */
