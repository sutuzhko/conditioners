...
/**
 * Раскрытие остальных моделей (issue #260). Витрина показывает полный ряд —
 * четыре карточки в одну, две и четыре колонки, три в три (issue #552), —
...
export const Collapsed: Story = {
  name: 'Витрина свёрнута: полный ряд и «Показать все N»',
  args: {
    products: [
      plainProduct,
      discountedProduct,
