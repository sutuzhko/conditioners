    ...
    <Card padding="xl" radius="xl" className={styles.card}>
      ...
      <div className={styles.body}>
        ...
        <div className={styles.summary}>
          {/* 🔴 Итог и кнопка стоят выше сметы, и это не вкусовщина, а способ
              не двигать то, во что целится палец (issue #677). Смета — это
              единственное, что меняет высоту: строк в ней от одной до пяти.
              Пока она стояла первой, каждая галочка сдвигала кнопку, и место
              под пять строк приходилось держать заранее — при одной строке
              под подписью оставалось 130px пустоты, и её видел каждый, кто
              открыл страницу. Растущее содержимое ушло в конец: теперь оно не
              толкает ничего, и резерв не нужен вовсе.

              Порядок чтения от этого не портится: сначала ответ и действие,
              потом объяснение, из чего ответ сложился. */}
          <TotalBar {...totalProps} />
