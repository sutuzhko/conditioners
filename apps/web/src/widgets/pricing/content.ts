...
export const pricingText = {
  ...
  /* 🔴 Третье состояние итога. На верхнем делении шкалы формула перестаёт
     ...
     скажут по телефону. */
  onSite: 'Считаем на выезде',
  onSiteText:
    'Длинная трасса и мульти-сплит считаются по месту: замерщик посмотрит стены и трассу и назовёт точную сумму до начала работ.',
