  ...
  return (
    <NavState initialOpen={navOpen}>
      ...
      {/* До 600px навигация уходит вниз экрана: колонка там не показывается
          ...
          🔴 Счётчики уходят и сюда: на телефоне колонки нет, а разделы с
          очередями лежат за «Ещё» — без них владелец не узнавал о работе
          нигде (issue #670). */}
      <AdminTabs role={role} counts={counts} />
    </NavState>
  );
}
