...
export const adminSummaryContent = {
  /** Заголовок ошибки блока сводки: что именно не приехало (issue #651). */
  ...
  upcomingNotFound: 'По этому отбору дел нет. Снимите условие или измените запрос.',
  /* 🔴 Действие, а не совет искать глазами: до него текст просил «снять
     условие над таблицей», и снимать его надо было вручную — пилюлями,
     которые в этот момент прокручены выше экрана (issue #580).

     Названо «Показать все дела» — как у заявок, клиентов и нарядов: у
     пустого состояния в панели действие называет то, что человек увидит, а
     «Сбросить отбор» остаётся именем ссылки в самой панели отбора. */
  upcomingNotFoundAction: 'Показать все дела',
