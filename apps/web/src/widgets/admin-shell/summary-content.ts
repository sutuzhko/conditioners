...
export const adminSummaryContent = {
  /**
   * Заголовок экрана. Сводка — единственный раздел панели, у которого своего
   * `h1` не было вовсе: все остальные заводят его в своей странице, а вход в
   * панель начинался сразу с карточек.
   */
  title: 'Сводка',
