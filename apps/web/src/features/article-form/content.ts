...
export const articleCoverContent = {
  ...
  /* 🔴 «Файла нет» — не то же, что «обложки нет»: запись осталась, и владельцу
     нужно либо загрузить файл заново, либо убрать обложку (issue #690). */
  gone: 'Файл обложки недоступен',
  goneNote: 'Загрузите обложку заново или уберите её',
