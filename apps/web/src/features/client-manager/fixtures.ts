...
/**
 * 🔴 Снимок пережил свой файл — issue #690.
 *
 * Адрес у снимка при этом **рабочий**: витрина показывает состояние
 ...
 *
 * Рядом стоит завеса без снимка вовсе: два вида пустоты должны быть видны в
 * одном кадре, иначе разницу между ними никто не проверит.
 */
export const goneUnits: readonly ClientUnitCard[] = [{ ...unit, photoMissing: true }, curtain];
