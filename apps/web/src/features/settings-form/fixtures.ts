...
/**
 * Запись, сохранённая до появления вариантов состава: заполненная, но без
 * переключателя. Схема разбирает такую по первому варианту, и форма обязана
 * читать её так же — иначе владелец видит пустую форму на непустых данных.
 */
export const legacyWithoutForm = {
  name: 'Иванов Иван Иванович',
  inn: '710703123450',
  ogrn: '314710700012346',
  address: 'г. Тула, ул. Замочная, д. 1, кв. 2',
