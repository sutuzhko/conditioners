...
export const deliveryLogContent = {
  ...
  codeCopy: 'Скопировать код',
  codeCopied: 'Код скопирован',
  /* 🔴 Один раз над списком, а не под каждым человеком (issue #38): пять
     одинаковых абзацев вытесняли сами адреса. */
  codeHint:
    'Код привязки диктуют человеку: он отправляет его сообщением боту, и бот ' +
