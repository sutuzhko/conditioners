    ...
    >
      {Array.from({ length: HOURS_IN_DAY }, (_, hour) => (
        <button
          ...
          /* 🔴 Ширина часа — ширина колонки дня, высота — сам час: и то и
             другое означает время, а не размер кнопки (ADR-236). На телефоне в
             неделе выходит 40×42; растянуть до 44×44 значит сдвинуть сетку и
             разойтись со шкалой времени слева. Запасной путь тот же, что у
             записи: вид дня, где колонка одна на всю ширину. */
          data-tap-size="essential"
        />
      ))}
