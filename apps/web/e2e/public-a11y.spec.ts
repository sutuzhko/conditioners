...
const KNOWN: readonly { readonly match: string; readonly issue: string }[] = [
  /* 🔴 Пусто — и это не «список ещё не завели», а состояние: все семь
     допущений сняты вместе со своими дефектами (#532–#536). Пустой список
     означает, что публичная часть проходит проверку целиком, без поблажек;
     новая запись здесь обязана называть issue и исчезнуть вместе с ним. */
];
