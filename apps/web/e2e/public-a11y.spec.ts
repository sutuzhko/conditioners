...
const KNOWN: readonly { readonly match: string; readonly issue: string }[] = [
  ...
  { match: 'Footer_contacts', issue: '#536 — подвал обходится не в порядке чтения' },
  { match: 'Footer_phone', issue: '#536 — подвал обходится не в порядке чтения' },
  { match: 'Footer_nav', issue: '#536 — подвал обходится не в порядке чтения' },
];
