 ...
 * меньше порога, тема совпадает с запрошенной, текст не обрезан и не вылит за
 * край, поверх цели никто не лежит, шрифты и картинки загрузились — верно для
 * любой истории при любых данных. Так 382 истории панели впервые получают
 * машинную проверку.
 *
