 ...
 * цель не меньше порога, тема совпадает с запрошенной, текст не обрезан, поверх
 * цели никто не лежит, шрифты и картинки загрузились. Эталона у них нет, и
 * категорий здесь три: нарушение — красит; допущение — параметр истории с
