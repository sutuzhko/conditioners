 ...
 * в двадцати, строка чекбокса 21px была в сорока пяти. Ставить допущение
 ...
 * снимается тем же PR, что его чинит: запись про чекбокс ушла вместе с
 * починкой (issue #475). Раннер применяет список поверх параметров историй;
