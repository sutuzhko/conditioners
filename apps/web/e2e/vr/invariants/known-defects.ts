 ...
 * снимается тем же PR, что его чинит: записи про ссылки и чип подбора ушли
 * вместе с починкой (issue #476). Раннер применяет список поверх параметров
 * историй; сводка показывает такие допущения с той же причиной, что и
 * параметры.
 *
