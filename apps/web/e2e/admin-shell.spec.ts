...
for (const shell of [
  {
    ...
    width: 390,
    height: 844,
    /* 🔴 Служебной строки на телефоне нет вовсе (issue #659): колонки на этой
       ширине не существует, кнопка сворачивания управляла бы невидимым, а
       переключатель темы уехал в лист «Ещё». Обход начинается прямо с
       содержимого раздела. */
    order: ['содержимое', 'полоса вкладок'],
    nav: 'полоса вкладок',
